...
# debug
./llama3.cpp/build/llama3 ./models/Llama3.2-1B.bin -n 32 -s 6515 -z "./tokenizer/tokenizer.bin" -i "I think Lava(?) is an accessible, open large language model (LLM) designed for" -d | tee -i run.log
